                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="${pageContext.request.contextPath }/admin/product/create">Create User</a>
                            </nav>
                        </div>
            ...
            <div id="layoutSidenav_content">
                <main class="container">
                    <section class="row" style="width: 1200px;">
                        <div class="col mt-4">
                            <form action="${pageContext.request.contextPath }/admin/product/save" method="POST" enctype="multipart/form-data" class="col-sm-12" id="form-1">
                                <div class="card mb-4">
                                        ...
                                        <div class="row">
                                            <div class="col-7">
                                                <div class="form-group">
                                                    ...
                                                    <small id="nameHid" class="form-text text-muted">${mess}</small>
                                                </div>
                                                <div class="input-group">
                                                    <span class="input-group-text">Price</span>
                                                    <input type="number" class="form-control" name="price" id="price" aria-describedby="price" placeholder="">
                                                    <span class="input-group-text">$</span>
                                                </div>
                                                <div class="form-group">
                                                    <label for="category_id">Category</label>
                                                    
                                                    <select class="form-control" name="category_idd" id="category_idd">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="status" id="status">
                                                        ...
                                                        <option value="3">Hết Hàng</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-3">
                                            <script type="text/javascript">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" onchange="chooseFile(this)" class="form-control" name="image"  placeholder="Product Image">
                                                    <small id="productImage" class="form-text text-muted">Nhập Image Product</small>
                                                </div>
                                                <div class="input-group">
                                                    <span class="input-group-text">Discount</span>
                                                    <input type="number" class="form-control" name="discount" id="discount" aria-describedby="discount" placeholder="">
                                                    <span class="input-group-text">%</span>
                                                </div>
